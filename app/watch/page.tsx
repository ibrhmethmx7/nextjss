...
function WatchContent() {
    ...
    return (
        <div ref={containerRef} className={`${isFullscreen ? 'fixed inset-0 bg-black z-50' : 'h-screen bg-[#0a0a0a] overflow-hidden'} text-white flex flex-col transition-all duration-300`}>
            ...
            <div className="flex flex-col overflow-hidden">
                ...
                <div className="flex flex-row" style={{ aspectRatio: '16/9', maxHeight: '65vh' }}>
                    ...
                    <div className="flex-1 relative">
                        <div className={`absolute inset-0 ${isFullscreen ? 'h-full' : ''}`}>
                            {/* Ambilight Effect */}
                            ...
                            {isFullscreen && (
                                <div className="absolute left-0 right-0 bottom-20 px-4 z-[60] pointer-events-none">
                                    ...
                                    <div className="max-w-md ml-auto pointer-events-auto">
                                        ...
                                        {/* Input */}
                                        <div
                                            className="flex gap-2 bg-black/50 backdrop-blur-sm rounded-lg p-2"
                    ...
                    {/* Desktop/Tablet Side Panel - Inside video row for same height */}
                    {!isFullscreen && (
                        <div className="hidden md:flex flex-col w-80 border-l border-white/5 bg-black/30">
